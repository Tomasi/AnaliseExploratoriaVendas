...
Idealmente seria interessantes que ela contesse uma massa maior de dados, com mais detalhes de vendas, tais dados poderiam influenciar previsão de vendas futuras, porém, para demonstrar a dispersão de dados, o gráfico de dispersão gerado através de dados atuais
